...
import cachet.apps.location_background.tasks.Task;
import cachet.apps.location_background.tasks.TaskFactory;
...
public class GeolocatorPlugin implements
  ...
  private static final String METHOD_CHANNEL_NAME = "flutter.baseflow.com/location_background/methods";
  private static final String EVENT_CHANNEL_NAME = "flutter.baseflow.com/location_background/events";
  ...
  public static void registerWith(Registrar registrar) {
    GeolocatorPlugin location_backgroundPlugin = new GeolocatorPlugin(registrar);
    ...
    methodChannel.setMethodCallHandler(location_backgroundPlugin);
    eventChannel.setStreamHandler(location_backgroundPlugin);

    registrar.addViewDestroyListener(location_backgroundPlugin);
  }
